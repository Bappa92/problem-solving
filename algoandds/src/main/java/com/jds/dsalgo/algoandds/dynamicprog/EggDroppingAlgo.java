 ...
 * 
 * k ==> Number of floors n ==> Number of Eggs eggDrop(n, k) ==> Minimum number
 * of trials needed to find the critical floor in worst case. eggDrop(n, k) = 1
 * + min{max(eggDrop(n - 1, x - 1), eggDrop(n, k - x)): x in {1, 2, ..., k}}
 * 
 * @author Bappa
 *
 */
public class EggDroppingAlgo {
